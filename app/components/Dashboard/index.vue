<template>
  <!--
  TailAdmin - Minimal design to create clean and simple admin panels
...
-->
  ...
  <div x-data="{ userDropdownOpen: false, mobileNavOpen: false }">
    ...
    <div
      id="page-container"
      class="mx-auto flex w-full min-w-[320px] flex-col bg-slate-100 rounded-lg"
    >
      <!-- Page Header -->
          ...
          <div class="flex justify-between border-b-2 border-slate-200/50 py-6">
            ...
            <div class="flex items-center">
              ...
              <a
                ...
                class="text-md group inline-flex items-center gap-1 font-bold tracking-wide text-slate-700 hover:text-indigo-600 active:text-slate-700 sm:text-lg"
              >
                <svg
                  class="hi-mini hi-square-3-stack-3d inline-block size-5 rotate-90 text-indigo-500"
          ...
          >
            ...
            >
              <svg
                ...
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
                class="hi-solid hi-home inline-block size-5 flex-none"
              >
                <path
            ...
            <div class="space-y-1.5">
              ...
              >
                <svg
                  class="hi-mini hi-cursor-arrow-rays inline-block size-5 flex-none text-slate-300 group-hover:text-indigo-500"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                  aria-hidden="true"
                ...
                <span
                  class="inline-flex items-center justify-center rounded-full border border-indigo-200 bg-indigo-50 px-1 text-xs text-indigo-900"
                  >250</span
                >
              </a>
              <a
              ...
              >
                <svg
                  class="hi-mini hi-chart-bar inline-block size-5 flex-none text-slate-300 group-hover:text-indigo-500"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                  aria-hidden="true"
            ...
            <div class="space-y-1.5">
              ...
              >
                <svg
                  class="hi-mini hi-user-group inline-block size-5 flex-none text-slate-300 group-hover:text-indigo-500"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                  aria-hidden="true"
              ...
              >
                <svg
                  class="hi-mini hi-briefcase inline-block size-5 flex-none text-slate-300 group-hover:text-indigo-500"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                  aria-hidden="true"
              ...
              >
                <svg
                  class="hi-mini hi-document-text inline-block size-5 flex-none text-slate-300 group-hover:text-indigo-500"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                  aria-hidden="true"
          ...
          <div class="grid grid-cols-1 md:gap-20 lg:grid-cols-12">
            ...
            <div class="lg:col-span-9">
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-12 md:gap-6">
                <div
                  class="rounded-lg border border-slate-200 bg-white p-6 sm:col-span-6 xl:col-span-3"
                >
                  <dl>
